...
/**
 * madari theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { madariTheme } from './madari';
 *   import './madari.css';
 */
export const madariTheme = {
  name: 'madari',
  __built: true,
  tokens: {
    "--color-accent": "light-dark(#3E481D, #8FF0A4)",
    ...
    "--color-on-accent": "light-dark(#FFFFFF, #233700)",
    "--color-neutral": "light-dark(#1B1C151A, #E2E3DA33)",
    "--color-background-surface": "light-dark(#FCFDF3, #1B1C15)",
    "--color-background-body": "light-dark(#F0F2E8, #101207)",
    "--color-overlay": "light-dark(#1B1C1566, #1B1C1599)",
    "--color-overlay-hover": "light-dark(#1B1C150D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#1B1C151A, #FFFFFF1A)",
    "--color-background-muted": "light-dark(#1B1C150D, #1B1C1580)",
    "--color-text-primary": "light-dark(#1B1C15, #E2E3DA)",
    "--color-text-secondary": "light-dark(#46483B, #AAAD9E)",
    "--color-text-disabled": "light-dark(#909284, #5D6052)",
    "--color-text-accent": "var(--color-accent)",
    "--color-on-dark": "#FFFFFF",
    "--color-on-light": "#3E481D",
    "--color-icon-accent": "var(--color-accent)",
    "--color-icon-primary": "light-dark(#1B1C15, #E2E3DA)",
    "--color-icon-secondary": "light-dark(#46483B, #AAAD9E)",
    "--color-icon-disabled": "light-dark(#909284, #5D6052)",
    "--color-background-card": "light-dark(#FCFDF3, #1B1C15)",
    "--color-background-popover": "light-dark(#FCFDF3, #30312A)",
    "--color-background-inverted": "light-dark(#1B1C15, #FCFDF3)",
    ...
    "--color-border": "light-dark(#1B1C151A, #F0F2E81A)",
    "--color-border-emphasized": "light-dark(#909284, #67695C)",
    "--color-skeleton": "light-dark(#AAAD9E, #46483B)",
    "--color-track": "light-dark(#AAAD9E, #46483B)",
    ...
    "--shadow-inset-hover": "inset 0px 0px 0px 2px rgba(62, 72, 29, 0.3)",
    "--shadow-inset-selected": "inset 0px 0px 0px 2px rgba(62, 72, 29, 0.5)",
